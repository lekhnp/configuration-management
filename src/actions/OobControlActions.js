...
export const addOobControl = (fromObj, fieldName) => {
  return (dispatch) => {
    dispatch({ type: START_SPINNER_ACTION });
        ...
        (data) => {
          if (
            ...
            dispatch({
              ...
              payload: {
                detail: handleAddOobControl(fieldName, data.responseCode)
                  .message,
                severity: handleAddOobControl(fieldName, data.responseCode)
                  .messageType,
              },
            });
          } else {
