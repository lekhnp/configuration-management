...
export const addOobSubmodule = (addOOBSubmoduleFormData, submoduleName) => {
  return (dispatch) => {
    dispatch({ type: START_SPINNER_ACTION });
    return fetch(OOB_SUBMODULE_API_URL, {
      method: "post",
        ...
        (data) => {
          if (
            ...
            dispatch({
              ...
              payload: {
                detail: handleAddOobSubmodule(submoduleName, data.responseCode).message,
                severity: handleAddOobSubmodule(submoduleName, data.responseCode).messageType,
              },
            });
          } else {
      ...
      .then(
        (data) => {
          if (
            ...
            data.responseObject.oobSubmodules.sort((a, b) =>
...
export const fetchOOBSubmodulesById = (masterSubmoduleId, oobModuleId) => {
  let API_URL =
    OOB_SUBMODULE_API_URL + "/" + masterSubmoduleId + "/" + oobModuleId;
  return (dispatch) => {
    dispatch({ type: START_SPINNER_ACTION });
    return fetch(API_URL, {
      headers: setRequestHeader(),
