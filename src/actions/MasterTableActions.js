...
import { ERROR_MESSAGE,handleUpdateMasterTable,handleMasterTableTerm} from "../utils/Messages";
        ...
        (data) => {
          if (
            ...
            dispatch({
              type: SHOW_SNACKBAR_ACTION,
              payload: {
                detail: handleUpdateMasterTable(formData.tableName, data.responseCode).message,
                severity: handleUpdateMasterTable(formData.tableName, data.responseCode).messageType,
              },
            });
          } else {
        ...
        (data) => {
          if (
            ...
            dispatch({
              type: SHOW_SNACKBAR_ACTION,
              payload: {
                detail: handleMasterTableTerm(tableName,data.responseCode).message,
                severity: handleMasterTableTerm(tableName,data.responseCode).messageType,
              },
            });
          } else {
