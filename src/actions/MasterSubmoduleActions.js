...
export const fetchMasterSubmodule = (startIndex, pageSize, search) => {
  ...
  if (search) API_URL = API_URL + "&search=" + search;
  return (dispatch) => {
...
export const addMasterSubmodule = (formData) => {
  let addSubmoduleFormData = {
    name: formData.submoduleName.trim(),
        ...
        (data) => {
          if (
            ...
            dispatch({
              type: SHOW_SNACKBAR_ACTION,
              payload: {
                detail: handleAddMasterSubmodule(addSubmoduleFormData.name, data.responseCode).message,
                severity: handleAddMasterSubmodule(addSubmoduleFormData.name, data.responseCode).messageType,
              },
            });
          } else {
        ...
        (data) => {
          if (
            ...
            dispatch({
              type: SHOW_SNACKBAR_ACTION,
              payload: {
                detail: handleUpdateMasterSubmodule(updateSubmoduleFormData.name, data.responseCode).message,
                severity: handleUpdateMasterSubmodule(updateSubmoduleFormData.name, data.responseCode).messageType,
              },
            });
          } else {
...
export const deleteMasterSubmodule = (moduleId, submoduleName) => {
  let API_URL = MASTERSUBMODULE_API_URL + "/" + moduleId;
  return (dispatch) => {
    dispatch({ type: START_SPINNER_ACTION });
    return fetch(API_URL, {
      method: "delete",
