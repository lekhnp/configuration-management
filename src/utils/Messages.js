...
export const handleMasterSubmoduleTerm = (
  ...
  else if (responseCode === "2044")
    return {
      message: `Can not term the component "${submoduleName}", it is already in use.`,
      messageType: "warning",
    };
  else return { message: ERROR_MESSAGE, messageType: "error" };
};

export const handleMasterTableTerm = (
  tableName,
  responseCode,
  error
) => {
...
export const handleResetPasswordError = (responseCode) => {
...
export const termModuleMessage = (moduleName) => {
  return `Are you sure you want to term module ${moduleName} ?`;
};
...
export const FieldTermMessage = (label) => {
  return `Are you sure you want to term field ${label ? label : ""}?`;
};
...
export const approvedOnField = (createdByUser) => {
  return `${createdByUser} approved on this field`;
};
export const fieldRetracted = (createdByUser) => {
  return `${createdByUser} retracted the sign off on this field`;
};
export const fieldSignOff = (createdByUser) => {
  return `${createdByUser} signed off on this field`;
};
...
export const removeAssociateModule = (name, version, moduleVersion) => {
  return (
    "Are you sure you want to remove association of module " +
    name +
    " version " +
...
export const handleRestoreOobSingleField = (fieldName, responseCode) => {
  if (responseCode === "200") {
    return {
      message: `The field ${fieldName} successfully Restored.`,
      messageType: "success",
    };
  } else {
    return {
...
export const handleDeleteOOBControl = (controlName, responseCode) => {
  if (responseCode === "200") {
    return {
      message: `The field ${controlName && controlName} successfully termed.`,
      messageType: "success",
    };
  } else {
    return {
...
export const OBBModuleTerm = (moduleName) => {
  return `${moduleName} module associated with OOB. You cannot term this module.`;
};
...
export const handleManageSubmoduleError = (Error) => {
  if (Error.responseCode && Error.responseCode === "2071")
    return {
      message: `Component is already associated`,
      messageType: "warning",
    };
  else return { message: COMMON_ERROR_MESSAGE, messageType: "error" };
};
...
export const handleBusinessLineError = (Error, clientId) => {
...
export const handleCompanyError = (Error, clientId) => {
  if (Error.responseCode && Error.responseCode === "2014")
    return {
      message: (
        <>
...
export const handleEligibilityGroupError = (Error, clientId) => {
  if (Error.responseCode && Error.responseCode === "2014")
    return {
      message: (
        <>
...
export const handleEligibilityPlanError = (Error, clientId) => {
  if (Error.responseCode && Error.responseCode === "2014")
    return {
      message: (
        <>
...
export const handleManageHierarchyActionError = (Error) => {
  if (Error.responseCode && Error.responseCode === "2008")
    return {
      message: "Level1 sheet name incorrect.",
      messageType: "error",
    };
  else return { message: COMMON_ERROR_MESSAGE, messageType: "error" };
};
