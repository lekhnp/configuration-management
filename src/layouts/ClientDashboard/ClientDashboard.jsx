...
import { handleClientDashboardError, GLOBAL_MODULE_DASH, MOD_DASHBOARD } from "../../utils/Messages";
...
const ClientDashboard = () => {
  ...
  useEffect(() => {
    if(OobModuleAnalyticsError || GlobalModuleAnalyticsError)
      setApiError(handleClientDashboardError(OobModuleAnalyticsError,GlobalModuleAnalyticsError))   
    else
      setApiError(false) 
  }, [OobModuleAnalyticsError,GlobalModuleAnalyticsError]);
