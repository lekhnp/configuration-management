...
import { DEFAULT_START_INDEX, DEFAULT_PAGE_SIZE, SET_DEFAULT_STARTINDEX} from "../../utils/AppConstants";
// import {
//   resetDuplicateError,
//   //fetchModuleById,
//   //deleteMasterModule,
...
import { handleMasterModuleError, MASTER_MODULE, NO_RECORDS_MESSAGE } from "../../utils/Messages";
...
const MasterModule = () => {
  ...
  //const totalPages = useSelector((state) => state.Pagination.DetailsList.totalPages);
  ...
  const startIndex = useSelector(
    (state) => state.MasterModule.page.startIndex
  );
  ...
  //     title: "Confirm",
  //     message: "Are you sure you want to term module " + e.moduleName + "?",
  //   };
  ...
  const handleSearch = () => {
    if (searchText !== ""){
      dispatch({type: SET_DEFAULT_STARTINDEX})
      dispatch(fetchMasterModule("All",DEFAULT_START_INDEX, pageSize, searchText));
    }
  }
      ...
      <PageHeading
        ...
        action={
          <Grid container style={{ width: "auto" }}>
            <Search handleChange={handleChange} handleKeyPress={handleKeyPress} handleSearch={handleSearch} />
          </Grid>
        }
      // action={
      //   <Grid container style={{ width: "auto" }}>
