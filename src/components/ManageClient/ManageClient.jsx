...
function ManageClient(props) {
  ...
  const { activeTab, open, disabled,
    handleClose, handleNext, handleAssign, handleFileUpload, handleSubmit } = props;
  ...
  function getTabContent(step) {
    switch (step) {
      ...
      case 1:
        return <TabAssignModules handleNext={handleAssign} handleDisabled={handleAssignDisabled}/>;
      case 2:
        return (
          <TabUploadFile
