...
import {
  handleUpdateMasterSubmoduleError,
  SUB_NAME_EXIST,
...
const UpdateMasterSubmodule = (props) => {
  ...
  useEffect(() => {
    if (
      ...
      setApiError(handleUpdateMasterSubmoduleError(putApiError,defaultFormData.submoduleName));
    }

    if (
      putApiError.responseCode &&
      putApiError.responseCode === "2043"
    ) {
      setApiError(false);
  ...
  }, [dispatch, putApiError, setError, isSubmoduleUpdated, handleCloseForm,defaultFormData.submoduleName]);
...
export default UpdateMasterSubmodule;
