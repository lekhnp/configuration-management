...
function MainMenu() {
  ...
  const menus = [
    ...
    {
      label: GLOBAL_CONF,
      path: `${url}/global-config`,
      icon: GlobalConfigurationIcon,
      activeFeature: VIEW_OOB_GLOBAL_CONFIG,
      activePages: ["admin/global-config"],
    },
    {
      label: APP_SETTINGS,
  ...
  const clientMenus = [
    ...
    },
    {
      ...
      path: `${url}/global-modules/${clientId}`,
      icon: GlobalIcon,
      activeFeature: "ALL",
      activePages: [
        `${url}/global-modules/${clientId}`,
        `${url}/components/Global`,
      ],
    },
    {
      ...
      //visibleFor: "MHK",
      icon: DeployIcon,
      activeFeature: VIEW_CONFIGURATION_DEPLOYMENT,
      activePages: [`${url}/config-deploy/${clientId}`],
    },
    // {
    //   label: LETTERS,
    ...
    //   //visibleFor: "MHK",
    //   icon: LetterIcon,
    //   //activeFeature: VIEW_LETTERS,
    //   activeFeature: VIEW_CONFIGURATION_DEPLOYMENT,
    //   activePages: [`${url}/letters/${clientId}`],
    // },
  ];
